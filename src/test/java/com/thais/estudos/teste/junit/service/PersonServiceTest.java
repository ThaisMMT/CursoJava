...
class PersonServiceTest {
    ...
    @Test
    @DisplayName("Should throw NullPointExcepiton with message when person is null")
    ...
    void filterRemovingNotAdult_Return_WhenListOfPersonWithAdultIsPassed() {
        Person person1 = new Person(17);
        Person person2 = new Person(18);
        Person person3 = new Person(31);
        List<Person> personList = List.of(person2,person1,person3);
